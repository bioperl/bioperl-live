...
the examples/root_object directory for a start. We have also created a 
...
a number of useful example scripts in the examples/root_object directory.
...
See examples/root_object/error.pl for demonstration code.
