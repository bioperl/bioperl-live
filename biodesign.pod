...
of everything that I did or thought when I started to use the package. After
...
a single module that I wrote. There is a brilliant sense of community in
Bioperl about providing useful, stable code and it should be a pleasure to
contribute to it.
...
inherit from the Root Object. The Bioperl root object allows a number of
...
You can go to L<Bio::Root::Object> for more information.
...
-E<gt>new function. This new function builds a hash, sets some root object
...
see the L<Object Context> section). So an exception like
