...
objects. Some of the key objects represent: Sequences, features on
...
It is very easy to write programs using the bioperl modules, as a lot
...
connect up a number of the modules to do useful things. The synopsis
...
Here is a very quick overview of some of the central objects in 
bioperl. Also see L<bptutorial.pl>


L<Bio::Seq> - sequence object
...
Please see L<bptutorial.pl>.


=head1 Database Access

Please see L<bptutorial.pl>, L<Bio::DB::GenBank>, L<Bio::DB::GenPept>,
L<Bio::DB::SwissProt>, L<Bio::DB::GDB>, and L<Bio::DB::Ace>.
