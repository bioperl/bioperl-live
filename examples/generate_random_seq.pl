...
# --c=1 option will cause prot sequences to be built using vertebrate aa frequencies, 
...
my @aa_frequencies = qw(744 991 1398 2017 2378 3104 3349 3726 4239 5273 5443 5749 6410 6848 7455 8263 8760 9340 9488 9713 10000);
&GetOptions
  (
   'l|length:s'          => \$length,
...
my $seq =  Bio::PrimarySeq->new(-seq => $sequence, -display_id => 'randomseq');
