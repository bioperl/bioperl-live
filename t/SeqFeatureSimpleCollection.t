# This is -*-Perl-*- code
## Bioperl Test Harness Script for the Bio::SeqFeature::SimpleCollection Module
##
# $Id $
...
BEGIN {
  ...
  $INTERFACE_NAME = "Bio::SeqFeature::CollectionI";
  $IMPLEMENTATION_NAME = "Bio::SeqFeature::SimpleCollection";
