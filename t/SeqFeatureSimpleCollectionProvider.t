# This is -*-Perl-*- code
## Bioperl Test Harness Script for the
## Bio::SeqFeature::SimpleCollectionProvider Module
##
# $Id $
...
BEGIN {
  ...
  $INTERFACE_NAME = "Bio::SeqFeature::CollectionProviderI";
  $IMPLEMENTATION_NAME = "Bio::SeqFeature::SimpleCollectionProvider";
