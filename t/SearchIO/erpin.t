...
float_eq($hsp->significance, 1.68e-05);
float_eq($hsp->expect, '1.68e-05', "HSP expect");
...
float_eq($hsp->significance, 5.61e-05);
is($hsp->end, 37, "HSP end");
float_eq($hsp->expect, '5.61e-05', "HSP expect");
isa_ok($hsp->seq, 'Bio::LocatableSeq');
