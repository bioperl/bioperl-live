package Bio::DB::SimpleFeatureProvider;

# $Id $
# A simple implementation of Bio::DB::FeatureProviderI with an
# in-memory backing store, for testing purposes.

=head1 NAME

Bio::DB::SimpleFeatureProvider -- A simple provider of collections of sequence
features, as if they were from a database or other non-trivial backing store.
