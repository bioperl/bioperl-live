#
# BioPerl module for Bio::TreeIO::TreeEventObjBuilder
#
...
Bio::TreeIO::TreeEventObjBuilder - Build Bio::Tree::Tree's and 
...
object made up of Bio::Tree::NodeI objects.
...
package Bio::TreeIO::TreeEventObjBuilder;
use strict;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::TreeIO::TreeEventObjBuilder->new();
 Function: Builds a new Bio::TreeIO::TreeEventObjBuilder object 
 Returns : Bio::TreeIO::TreeEventObjBuilder
 Args    : Named argument-value pairs:

                -treettype   the class to instantiate for trees, default
                             is Bio::Tree::Tree

                -nodetype    the class to instantiate for nodes, default
                             is Bio::Tree::Node
