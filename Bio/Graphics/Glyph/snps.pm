package Bio::Graphics::Glyph::snps;
#$Id$

use strict;
use Bio::Graphics::Glyph::triangle;
use vars '@ISA','$VERSION';
@ISA = 'Bio::Graphics::Glyph::triangle';
$VERSION = 1.01;
...
Bio::Graphics::Glyph::snps - The "snps" glyph
...
This is used for drawing triangles with score values.  The
color intensity of each feature is proportionate to its score.
