...
# $Id$
#
# BioPerl module Bio::Search::Result::PsiBlastResult
#
...
Bio::Search::Result::PsiBlastResult - A top-level BLAST Report object
...
package Bio::Search::Result::PsiBlastResult;
...
=head2 to_string
 ...
 Returns : A string of the form:
           [PsiBlastResult] <analysis_method> query=<name> <description> db=<database
           e.g.:
           [PsiBlastResult] BLASTP query=YEL060C vacuolar protease B, db=PDBUNIQ 
 Args    : None
...
#---------------
    my $self = shift;
    my $str = "[PsiBlastResult] " . $self->analysis_method . " query=" . $self->query_name . " " . $self->query_description .", db=" . $self->database_name;
    return $str;
}
