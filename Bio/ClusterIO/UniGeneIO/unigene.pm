...
Bio::ClusterIO::UniGeneIO::unigene - UniGene input stream

=head1 SYNOPSIS

Do not use this module directly.  Use it via the Bio::Cluster::UnigeneIO class.
...
# Let the code begin...
package Bio::ClusterIO::UniGeneIO::unigene;
use vars qw(@ISA);
use strict;
...
@ISA = qw(Bio::ClusterIO::UniGeneIO);
