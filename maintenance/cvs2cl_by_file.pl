...
###########################################################################
# This is a quick hack version of cvs2cl.pl (see below)
# that simply outputs in a file-centric mannor.
# only CVS::Utils::ChangeLog::EntrySet::Output::output_changelog
# was altered
# 
# Usage:
...
This is a quick hack version of cvs2cl.pl that simply outputs in a
file-centric way.
Only CVS::Utils::ChangeLog::EntrySet::Output::output_changelog
was altered
...
Original cvs2cl docs now follow, but some things may not work because of
the hack!
