...
NOTE : This is an file auto-generated by the helper script
maintenance/dependencies.pl. Do not edit directly!

The following packages are used by BioPerl. Not all are required for BioPerl to
operate properly, however some functionality will be missing without them. You
can easily choose to install all of these during the normal installation
