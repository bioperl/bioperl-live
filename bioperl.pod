## $Id: bioperl.pod,v 1.34 2002-08-14 18:16:42 bosborne Exp $
...
to check the documentation in the modules as well - there are over 500
...
I<examples/gb2features.pl> - shows how to extract all the features from
a Genbank file. See L<Bio::Seq> for more information on features
...
I<examples/pise/*> - scripts that demonstrate how to use Pise to run 
bioinformatic applications and parse their output (Pise integrates
with more than 250 different apps, including EMBOSS!) See 
L<Bio::Tools::Run::PiseApplication> for more information.

I<examples/longorf.pl> - a script that finds the longest ORF in one or
...
I<scripts/revcom_dir.pl> - return reverse complement sequences of
...
I<scripts/dbsnp.pl> - how to parse a dbsnp XML file. See L<Bio::ClusterIO> 
for details
...
I<scripts/feature_draw.pl> - script that accepts files in GFF or
tab-delimited format and creates corresponding PNG image files. See
L<Bio::Graphics> and L<Bio::Graphics::FeatureFile> for more information
...
I<scripts/parse_codeml.pl> - script that parses output from codeml, one
of the PAML programs. See L<Bio::Tools::Phylo::PAML>
...
I<scripts/waba2gff.pl> - convert raw WABA output to one type of GFF
